...
def save_xyz_file(coord_list, element_list, file_name, additional_name):
...
if __name__ == '__main__':
    ...
    with open(os.path.splitext(original_input_file)[0]+"_scan_energy_profile.csv", "w") as f:
    ...
    for i in range(scan_part):
        ...
        with open(os.path.splitext(original_input_file)[0]+"_scan_energy_profile.csv", "a") as f:
