from multioptpy.parameter import UnitValueLib, UFF_VDW_distance_lib, UFF_VDW_well_depth_lib, GNB_VDW_radii_lib, GNB_VDW_well_depth_lib
from multioptpy.calc_tools import torch_rotate_around_axis, torch_align_vector_with_z
